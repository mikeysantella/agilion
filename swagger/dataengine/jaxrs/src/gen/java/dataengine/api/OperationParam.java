...
public class OperationParam  implements Serializable {
  ...
  **/
   ...
   * @return required
  **/
  @ApiModelProperty(required = true, value = "whether this parameter is required")
  ...
  **/
  @ApiModelProperty(required = true, value = "if true, then a list of values is expected")
  ...
  **/
  @ApiModelProperty(value = "possible values from which to choose (if applicable)")
