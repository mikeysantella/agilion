...
import dataengine.auth.Authentication;
import dataengine.auth.HttpBasicAuth;
import dataengine.auth.ApiKeyAuth;
import dataengine.auth.OAuth;


public class ApiClient {
  private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  private String basePath = "http://virtserver.swaggerhub.com/deelam/DataEngine/0.0.1";
