...
public class OperationParam implements Serializable {
  ...
  **/
  @NotNull
  @ApiModelProperty(example = "null", required = true, value = "map of type for each parameter")
  ...
  **/
  @NotNull
  @ApiModelProperty(example = "null", required = true, value = "whether this parameter is required")
  ...
  **/
  @NotNull
  @ApiModelProperty(example = "null", required = true, value = "if true, then a list of values is expected")
  ...
  **/
  @ApiModelProperty(example = "null", value = "possible values from which to choose (if applicable)")
